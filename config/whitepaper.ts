...
export const whitepaperMeta = {
  title: "Atlas",
  tagline: "An AI-Managed Vault, and the Platform Built to Carry More",
  version: "v1.0",
  updated: "July 2026",
  readingTime: "14 min read",
};
...
export const docPages: DocPage[] = [
  {
    ...
    subsections: [
      ...
      {
        id: "the-vault-is-the-first-product",
        title: "The vault is the first product, not the only one",
        blocks: [
          {
            type: "paragraph",
            text: "Everything described in this document — the vault, the manager role, the on-chain constraints — is a real, specific product: the first one built on Atlas's underlying engine. That same engine (the vault factory, the decision engine, the market signal pipeline) is designed to eventually support more than one product: infrastructure other teams can build their own vaults on, a signal feed other agents and researchers can query, and a marketplace for sharing allocation strategies. Where this documentation describes something specific to the vault, it says so; where it describes the platform underneath, it says that instead.",
          },
        ],
      },
      {
        ...
        blocks: [
          {
            ...
            items: [
              "[The Portfolio Management Gap](/whitepaper/portfolio-gap) — why this problem exists and why nothing currently solves it.",
              "[The Vault Model](/whitepaper/vault-model) — where your money actually sits, and why the agent never touches it directly.",
              "[How a Rebalance Works](/whitepaper/how-rebalancing-works) — the exact step-by-step of what happens when the agent decides to act.",
              "[Constraints & the Trust Model](/whitepaper/constraints-trust-model) — the actual limits placed on the agent, and how they're enforced.",
              "[Use Cases](/whitepaper/use-cases) — concrete examples of who this is for and what it looks like in practice.",
              "[Supported Stock Tokens](/whitepaper/supported-stock-tokens) and [Fee Structure](/whitepaper/fee-structure) — the practical details.",
              "[The Platform](/whitepaper/the-platform) — what's built on the same engine beyond the vault, and how it's sequenced.",
              "[Security, Honesty & Roadmap](/whitepaper/security-honesty-roadmap) — including what we haven't finished yet. We think this matters more than most documentation admits.",
              "[FAQ & Glossary](/whitepaper/faq-glossary) — quick answers and definitions if you just want the short version of something.",
            ],
          },
    ...
    subsections: [
      ...
      },
      {
        ...
        blocks: [
          {
            type: "paragraph",
            text: "A real asset class — tokenized real stocks — exists today, is liquid, and is growing, but has no dedicated, automated management layer built for it. That's the gap. Atlas's vault is built specifically to fill it, rather than repurposing a tool meant for something else.",
          },
        ],
      },
    ],
  },
  {
    ...
    subsections: [
      {
        id: "most-important-decision",
        title: "The single most important design decision in the vault",
        blocks: [
          {
            type: "paragraph",
            text: "Before explaining how the agent thinks or trades, it's worth explaining something more basic: where does your money actually go, and who can touch it?",
          ...
          {
            type: "paragraph",
            text: "**The vault never gives Atlas custody of your funds.** This is worth dwelling on, because it's the foundation everything else is built on top of — and it's a property of the underlying engine, not just this one product.",
          },
        ],
      },
      {
        ...
        blocks: [
          ...
          {
            type: "paragraph",
            text: "The vault is built the opposite way. When you deposit funds, they go into a **vault** — a smart contract, which is really just a small program living on the blockchain, whose rules are fixed and visible to anyone. This vault is created for you, and functionally, it's yours: you can see everything in it, you can withdraw from it, and no one — including Atlas the company — can move funds out of it except in the specific ways the contract allows.",
          },
        ],
      },
      {
        ...
        blocks: [
          {
            type: "paragraph",
            text: "The vault's AI agent is given something called a **manager role** on your vault. This sounds like a big grant of power, but it's actually very narrow by design. The manager role allows the agent to call exactly one function: a rebalance function. It cannot withdraw your funds to some other address. It cannot send your money anywhere except into the specific, pre-approved trades that function allows — and even those trades are boxed in by rules described in detail on the [Constraints & the Trust Model](/whitepaper/constraints-trust-model) page (hard limits on trade size, which assets are allowed, and more).",
          },
          {
            type: "paragraph",
            text: 'A useful way to think about it: imagine giving someone a key that only opens one specific cabinet in your house, and that cabinet only lets them swap one approved item for another approved item, in limited quantities, on a limited schedule. That\'s closer to what the manager role actually is than "Atlas controls your money."',
          },
        ],
      },
      {
        ...
        blocks: [
          {
            ...
            items: [
              "**Deposit and withdraw** your funds, at any time, without asking anyone's permission.",
              "**See everything.** Since the vault lives on a public blockchain, your holdings and full transaction history are visible and verifiable by you directly — not just something Atlas tells you about.",
              "**Change your own rules** — for example, tightening your risk limits or changing which sectors you're comfortable holding.",
              "**Revoke the agent's access completely.** One action turns your vault back into a plain holding that nothing but you can touch — instantly, without a waiting period or an approval process.",
            ],
          },
      ...
      },
      {
        ...
        blocks: [
          {
            type: "paragraph",
            text: "It would genuinely be easier, from an engineering standpoint, to build the vault as a normal company that takes your deposit and manages it internally, the way a traditional fund does. We didn't do that, on purpose. The tradeoff of the vault model is that it's more complex to build — but the benefit is that your worst-case exposure is fundamentally limited. If Atlas the company ceased to exist tomorrow, your funds would still be sitting in a vault only you can withdraw from. That's not true of most financial products, and we think it should be true of this one. It's also a design principle we intend to carry into every other product built on the same engine, not just the vault.",
          },
        ],
      },
    ],
  },
  {
    ...
    title: "How a Rebalance Works",
    intro:
      "This page walks through, in order, exactly what happens from the moment the vault's agent notices something to the moment (if it happens) that a trade executes. Nothing here is simplified to the point of hiding a step — if you want to understand exactly what the agent does on your behalf, this is the page that answers it in full.",
    subsections: [
      {
        id: "step-1",
        title: "Step 1: Continuous monitoring, not scheduled check-ins",
        blocks: [
          {
            type: "paragraph",
            text: "Unlike a human advisor who might review your account once a quarter, the vault's agent is always watching. Specifically, it continuously tracks:",
          },
          {
            type: "list",
            items: [
      ...
      },
      {
        ...
        blocks: [
          {
            type: "paragraph",
            text: "If a proposal clears both checks, the trade actually executes on-chain. Rather than building custom trading infrastructure from scratch, the vault routes trades through established, already-live liquidity providers on Robinhood Chain (such as 1inch and 0x), which helps ensure you get a fair, competitive price given how much liquidity is actually available at that moment.",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    title: "Constraints & the Trust Model",
    intro:
      "The vault's agent is autonomous, but autonomy is not the same as unlimited authority. Every action the agent can take is bounded by rules enforced in the smart contract itself — not by the agent's judgment, not by a policy document, and not by our word. This page explains exactly what those boundaries are, where they live, and how you can verify them yourself.",
    subsections: [
      {
        id: "core-principle",
        title: "The core principle",
        blocks: [
          {
            type: "paragraph",
            text: "Most \"AI manages your money\" products ask you to trust the model. The vault is built so that you don't have to — because the model isn't what stops it from doing something you didn't authorize. The contract is.",
          },
          {
            type: "paragraph",
            text: "Concretely: the agent holds a restricted **manager role** on your vault. That role can only call one function — `rebalance()` — and that function is hard-gated by constraints written directly into the contract. If a proposed action falls outside those constraints, the transaction simply fails. It doesn't matter how the agent reasoned its way there.",
        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              "**It does not guarantee returns.** Constraints govern *how* the agent can act, not whether its judgment about *when* to act will be profitable. Rebalancing well is still subject to market risk.",
              "**It does not eliminate smart contract risk.** Like any on-chain system, the vault contract itself is subject to audit findings and the general risks of smart contract security, even with no bugs found. We publish audit results and encourage you to review them independently.",
              "**It does not replace your own judgment about whether the vault is right for you.** The constraints protect you from the agent exceeding what you authorized — they don't substitute for deciding what you should authorize in the first place.",
            ],
          },
        ],
      },
  ...
  },
  {
    ...
    title: "Use Cases",
    intro:
      "Rather than describing this abstractly, here are concrete pictures of who ends up using the vault and what their experience actually looks like.",
    subsections: [
      {
        id: "hands-off-holder",
        title: "The hands-off holder",
        blocks: [
          ...
          {
            type: "paragraph",
            text: "**What using the vault looks like for them:** they deposit funds once, set a target allocation and risk tolerance (say, \"I'm comfortable with moderate volatility, no more than 40% in any single sector\"), and then largely leave it alone. Every so often, they get a notification: a rebalance happened, with a plain-English explanation of why. They can check their dashboard whenever curiosity strikes, but they don't need to.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        blocks: [
          {
            type: "paragraph",
            text: "**Who they are:** a team that wants to offer their own users an AI-managed vault product, without spending the time to design and audit the underlying contracts, decision engine, and monitoring infrastructure themselves.",
          },
          {
            type: "paragraph",
            text: "**What this looks like for them:** rather than using the vault product directly, they build on the same engine it runs on. See [The Platform](/whitepaper/the-platform) for how this is sequenced — this is a later-phase product, not something available today.",
          },
        ],
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: "paragraph",
        text: "The vault works with a deliberately limited, curated list of Stock Tokens issued on Robinhood Chain, along with a small number of approved on-chain yield positions (such as Morpho-based stablecoin yield markets).",
      },
    ],
    subsections: [
      {
        ...
        blocks: [
          {
            type: "paragraph",
            text: "It might seem like more supported assets would automatically be better, but the vault treats this list as a safety boundary, not just a feature waiting to be expanded. An asset is only added once we've confirmed there's enough real on-chain trading liquidity to support execution within the vault's slippage and trade-size constraints. An asset that technically exists but trades thinly isn't a good fit for an automated system executing trades on your behalf — thin liquidity means worse prices and higher risk of something going wrong during execution.",
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    title: "The Platform",
    intro:
      "The vault described throughout this document is the first product built on Atlas's underlying engine — the vault factory, the decision engine, and the market signal pipeline that power it. This page describes what else is planned on top of that same foundation, and how honestly we're sequencing it: nothing on this page is live today.",
    subsections: [
      {
        ...
        blocks: [
          {
            type: "paragraph",
            text: "The contracts and decision engine behind the vault are designed to eventually be licensed, so other teams can launch their own AI-managed vault product on the same rails instead of building the underlying infrastructure from scratch. This is planned for after the vault itself has a real, live track record — infrastructure is only worth building on once it's proven, and it isn't yet.",
          },
        ],
      },
      {
        id: "market-signal-feed",
        title: "Market Signal Feed",
        blocks: [
          {
            type: "paragraph",
            text: "The volatility, trend, drawdown, and macro regime signals the vault's agent evaluates before every decision are planned to be made available as a queryable feed for other agents, researchers, or protocols — separate from the vault's own decision logic, which stays proprietary to Atlas.",
          },
        ],
      },
      {
        ...
        blocks: [
          {
            type: "paragraph",
            text: "Once natural-language strategy input exists as a vault feature, we plan to let users publish their allocation strategies for others to adopt, with a revenue share back to the original author. This depends on the underlying feature shipping first and does not exist yet in any form.",
          },
        ],
      },
    ],
    closing:
      "See [Security, Honesty & Roadmap](/whitepaper/security-honesty-roadmap) for exactly where each of these sits in our build sequence. We'd rather list these plainly as planned than describe them as available before they are.",
  },
  {
    slug: "security-honesty-roadmap",
    group: "Protocol",
    ...
    subsections: [
      ...
      },
      {
        ...
        blocks: [
          {
            type: "paragraph",
            text: "The first five phases below build and harden the vault itself. The final three extend the same engine into the platform products described on [The Platform](/whitepaper/the-platform) page, and only begin once the vault's trust and safety features are in place.",
          },
        ],
      },
    ],
    roadmapPhases: [
      ...
      {
        label: "Phase 7 — Market Signal Feed",
        description:
          "Metered access to the normalized market signal feed for other agents, researchers, or protocols.",
      },
      {
        label: "Phase 8 — Strategy Sharing",
        description:
          "Publishable, shareable natural-language allocation strategies, with revenue share to the creator.",
      },
    ],
    note: "Phases 0–5 run entirely on the founder's own funds and no outside capital — no outside capital is at risk before a closed beta, which is announced separately once legal and compliance review for the vault product is complete. Phases 6–8 have no committed start date and begin only once the phases before them are live and proven.",
    closing:
      "We'll keep this page updated as each phase completes — including being upfront if something doesn't go according to plan.",
  },
  {
    ...
    faqs: [
      {
        question: "What is Atlas, in one sentence?",
        answer:
          "A platform for AI-managed on-chain portfolios. Its first product is a vault: an AI agent that manages tokenized real stocks and on-chain yield on your behalf, automatically rebalancing within limits you set, and explaining every action in plain language.",
      },
      {
        question: "Is the vault the only thing Atlas offers?",
        answer:
          "Today, yes — the vault is the only live product. The same engine behind it is designed to eventually support more: infrastructure other teams can build on, a market signal feed, and a strategy-sharing marketplace. See The Platform and the Roadmap for exactly how that's sequenced and what's not built yet.",
      },
      {
        question: "Does the vault ever hold or control my funds directly?",
        answer:
          "No. Your funds stay in a smart contract vault that only you can withdraw from. The agent has a narrow, specific permission to execute rebalances within rules you've already agreed to — it cannot take custody, exceed your limits, or move funds anywhere outside the approved process.",
      },
      {
        question: "Could the agent do something I didn't authorize?",
        answer:
      ...
      {
        question:
          "Is using the vault the same as getting investment advice? Is it regulated?",
        answer:
          "The vault is built so that you define your own rules and boundaries, and the agent simply executes within them mechanically, rather than making independent, discretionary judgments about your money. This structure is intended to sit outside typical investment-advisory regulation, but we're having this confirmed by securities counsel rather than assuming it ourselves — and we'll update this answer once that review is complete.",
      },
      {
        question: 'What exactly is a "Stock Token"?',
        answer:
      ...
      {
        question:
          "Does the vault guarantee I'll make money, or at least not lose money?",
        answer:
          "No, and be wary of anything that claims otherwise. The vault's rules and constraints control *how* the agent is allowed to act — not whether the underlying market moves in your favor. Like any investment, there is a real risk of loss.",
      },
    ],
    glossary: [
      {
        term: "Vault",
        definition:
          "The smart contract holding your deposited funds. You retain full control and full withdrawal rights at all times; it is not held or controlled by Atlas the company. The vault is the first product built on Atlas's platform engine.",
      },
      {
        term: "Manager role",
        definition:
          "The narrow, specific permission granted to the vault's agent, allowing it to call a constrained rebalancing function — and nothing more.",
      },
      {
        term: "Rebalance",
        definition:
      ...
      },
      {
        term: "AUM (Assets Under Management)",
        definition:
          "The total value of the funds the vault is actively managing on your behalf; used as the basis for calculating the vault's management fee.",
      },
      {
        term: "Slippage",
        definition:
          "The difference between the expected price of a trade and the actual price it executes at, typically caused by limited available liquidity at the moment of the trade. The vault enforces a maximum slippage tolerance you set, blocking trades that would exceed it.",
      },
      {
        term: "Platform",
        definition:
          "The shared vault factory, decision engine, and market signal pipeline underlying every Atlas product. The vault is the first product built on it; vault infrastructure, the market signal feed, and strategy sharing are planned to follow.",
      },
    ],
  },
];
